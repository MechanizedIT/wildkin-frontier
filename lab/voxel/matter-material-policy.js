...
export const MATTER_MATERIAL=Object.freeze({AIR:0,ROCK:1,DIRT:2});
...
const policies=new Map([[ROCK_MATTER_POLICY.material,ROCK_MATTER_POLICY],[DIRT_MATTER_POLICY.material,DIRT_MATTER_POLICY]]);
