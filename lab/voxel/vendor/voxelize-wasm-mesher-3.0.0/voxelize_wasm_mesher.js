/* @ts-self-types="./voxelize_wasm_mesher.d.ts" */
 ...
 * @returns {any}
 */
export function mesh_chunk(input) {
    const ret = wasm.mesh_chunk(input);
    return ret;
}

/**
 * @param {Array<any>} chunks_data
 * @param {Int32Array} min
 * @param {Int32Array} max
 * @param {number} chunk_size
 * @returns {any}
 */
export function mesh_chunk_fast(chunks_data, min, max, chunk_size) {
    const ptr0 = passArray32ToWasm0(min, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray32ToWasm0(max, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.mesh_chunk_fast(chunks_data, ptr0, len0, ptr1, len1, chunk_size);
    return ret;
}
 ...
 * @returns {any}
 */
export function mesh_chunk_full(input) {
    const ret = wasm.mesh_chunk_full(input);
    return ret;
}
 ...
 * @param {any} registry
 */
export function set_registry(registry) {
    wasm.set_registry(registry);
}
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_instanceof_Uint32Array_c68067ce93bcb0e1: function(arg0) {
            let result;
            try {
        ...
        __wbg_prototypesetcall_26a86dd8c73de125: function(arg0, arg1, arg2) {
    ...
    return {
        __proto__: null,
        "./voxelize_wasm_mesher_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('voxelize_wasm_mesher_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
