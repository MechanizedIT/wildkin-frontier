...
try{
  ...
  const result={pass:true,checks:["Packaged same-shell boot, six regions, no external requests","Already-loaded movement and menus work with network offline","Graphics context-loss recovery message"],requests,external,errors};
