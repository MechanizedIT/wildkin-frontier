...
<html lang="en">
  <head>
    ...
    <title>Wildkin Frontier — Phase 3.5B</title>
    ${cssInline}
  ...
  <body>
    <div id="app" aria-label="Game canvas container">
      ...
      <div id="hud" aria-hidden="false">
        <div class="hud-top">
          <div class="badge">
            <strong>WILDKIN FRONTIER — Phase 3.5B</strong>
            <small>Author Mode · Camp + Area 1 Skeleton</small>
          </div>
        ...
        <div class="hud-bottom">
          <div id="debug-label">Phase 3.5B — 0.10.0 · starting…</div>
