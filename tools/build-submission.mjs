...
<html lang="en">
  <head>
    ...
    <title>Wildkin Frontier — Phase 3.5B.1</title>
    ${cssInline}
  ...
  <body>
    <div id="app" aria-label="Game canvas container">
      ...
      <div id="hud" aria-hidden="false">
        <div class="hud-top">
          <div class="badge">
            <strong>WILDKIN FRONTIER — Phase 3.5B.1</strong>
            <small>Author Mode Usability · Live Preview · Direct Placement</small>
          </div>
        ...
        <div class="hud-bottom">
          <div id="debug-label">Phase 3.5B.1 — 0.10.1 · starting…</div>
