...
def create_straight():
    ...
    for x in (-1.22,1.22):
        ...
        box('blue grey broad cap',(x,1.62,0),(.36,.16,.36),3,.028)
        brace('outboard triangular buttress',x)
        box('ground shoe',(x,.06,.36),(.30,.12,.52),1,.018)
        box('brace face facet',(x,.125,.54),(.22,.08,.13),3,.01)
...
def create_post():
    ...
    box('orange corner marker',(0,1.69,0),(.20,.02,.20),4,.005)
...
manifest={
 ...
 'pivot':[0,0,0],
 'modularPitch':2.8,
 'straightBounds':{'min':[-1.4,0,-.184],'max':[1.4,1.7,.62]},
 'collisionRecommendation':{
  'panel':{'center':[0,.85,0],'size':[2.8,1.7,.368]},
  'feet':[{'center':[x,.08,.4],'size':[.30,.16,.44]} for x in (-1.22,1.22)],
 ...
 'render':{'engine':'Cycles CPU','threads':2,'samples':12,'freshGLB':True,'images':['front.png','rear.png','three-quarter.png','side.png','corner-post.png','game-scale-neutral.png']},
