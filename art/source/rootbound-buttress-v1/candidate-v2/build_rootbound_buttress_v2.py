...
# Correct Blender convention: Z is vertical. Four roots form a closed grounded
# lower mass, then three unequal branches rise above walking height into three
# deliberately porous canopy lobes.
trunk = cone("buttress_trunk", 1.05, 0.50, 3.35, (0, 0, 1.675), BARK, 10)
branch("buttress_root_front", (0.26, -0.12, 0.52), (1.85, -1.55, 0.06), 0.52, 0.18, BARK_LIT)
branch("buttress_root_left", (-0.38, 0.10, 0.48), (-2.28, 0.64, 0.06), 0.50, 0.17, BARK)
branch("buttress_root_right", (0.50, -0.10, 0.44), (2.12, -0.82, 0.06), 0.48, 0.17, BARK_LIT)
branch("buttress_root_back", (-0.12, -0.42, 0.42), (-1.20, -1.96, 0.06), 0.45, 0.15, BARK)

branch("branch_left", (-0.20, 0.04, 2.70), (-1.65, 0.10, 4.15), 0.38, 0.20, BARK)
branch("branch_top", (0.10, 0.00, 3.00), (0.32, -0.08, 4.65), 0.38, 0.18, BARK_LIT)
branch("branch_right", (0.23, -0.03, 2.60), (1.75, -0.06, 3.95), 0.36, 0.18, BARK)
lobe("canopy_left", (-1.75, 0.06, 4.42), (1.45, 1.05, 0.92), LEAF_MID)
lobe("canopy_top", (0.26, -0.08, 4.95), (1.24, 1.05, 0.90), LEAF_DARK)
lobe("canopy_right", (1.75, -0.08, 4.15), (1.34, 0.98, 0.88), LEAF_LIT)

lobe("canopy_left_cap", (-2.12, 0.14, 4.72), (0.72, 0.58, 0.50), LEAF_LIT)
lobe("canopy_top_cap", (0.04, -0.12, 5.40), (0.62, 0.54, 0.42), LEAF_LIT)
lobe("canopy_right_cap", (2.03, -0.08, 4.43), (0.68, 0.52, 0.50), LEAF_DARK)
...
def point_camera(position, target=(0, 0, 3.0)):
...
payload = {
    "method": "manual-blender-structural-rebuild-v2-after-independent-v1-hold",
