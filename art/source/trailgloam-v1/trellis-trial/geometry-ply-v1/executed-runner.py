    ...
    try:
        ...
        with torch.inference_mode():
            if stage == 'background':
                ...
                import o_voxel
                glb = o_voxel.postprocess.to_glb(vertices=mesh.vertices, faces=mesh.faces, attr_volume=mesh.attrs.cpu(), coords=mesh.coords.cpu(), layout=mesh.layout, voxel_size=mesh.voxel_size, aabb=[[-.5, -.5, -.5], [.5, .5, .5]], decimation_target=plan['requested_run']['faces'], texture_size=1024, remesh=False, verbose=True)
