...
- CUDA reports a total in [7.5, 8.5] GiB, free VRAM of at least **7.0 GiB**, memory_allocated <= 0.25 GiB, and memory_reserved <= 0.25 GiB;
...
The retained 1,804,432 faces stay below the installed service 2,000,000 pre-simplification threshold; no preliminary simplification is added. CuMesh/BVH, remesh, UV/bake and simplification make a separate textured derivative, never modify the retained PLY, and do not claim a shape repair.
