...
# Export may split vertices for skin/corner attributes. The executed R1a
# version is archived beside the GLB. inspect_fitted.py owns the stronger
# neutral-surface/UV comparison; triangle count guards against missing faces.
assert len(mesh.data.polygons)==report['triangles']
