...
const points=[{name:'arrival',x:-2080,z:-3160,yaw:-2.783},{name:'interior',x:-2095,z:-3080,yaw:2.622},{name:'destination',x:-2140,z:-3005,yaw:-.733},{name:'overhead',x:-2110,z:-3075,yaw:0,height:210}];
