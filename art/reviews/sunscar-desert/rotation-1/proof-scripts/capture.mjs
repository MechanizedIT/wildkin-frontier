...
const points=[{name:'arrival',x:-1975,z:-6,yaw:1.35},{name:'interior',x:-1930,z:28,yaw:-3.09},{name:'destination',x:-1934,z:87,yaw:1.11},{name:'overhead',x:-1930,z:45,yaw:0,height:125}];
