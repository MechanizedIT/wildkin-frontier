...
export function createBetaShell({ app, getModel, onAction = () => null, onBlockingChanged = () => {}, canOpen = () => true, openInventory = null } = {}) {
  ...
  function showWelcome() { endFieldTool(); welcome = true; opened = false; modal.hidden = false; root.classList.add("is-open", "is-welcome"); setBlocking(true); render(true); focusModal(); }
