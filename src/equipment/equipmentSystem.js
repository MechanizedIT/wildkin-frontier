...
export function createEquipmentSystem({ progress, cancelTool = () => {}, setToolEquipped = () => {}, heal, eat, beginTaming, openBuild, isCamp = () => false, canUse = () => true, notify = () => {} }) {
  ...
  function use() {
    ...
    if (item.kind === 'food') return eat(item);
