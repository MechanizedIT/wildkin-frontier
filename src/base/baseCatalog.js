...
export const BASE_PIECES = Object.freeze([
  ...
  { id: 'workbench', name: 'Salvage bench', icon: '⚒', assetId: 'asset_salvage_bench', size: [1.97,1.277,.9965], cost: { wood: 6, stone: 3, fiber: 2 }, description: 'Assemble lures and simple snares at its working surface.' },
