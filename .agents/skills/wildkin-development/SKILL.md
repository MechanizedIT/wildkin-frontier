...
- For the September13 early-alpha mandate, apply the two-batch trial in [ALPHA_WORKFLOW.md](../../../docs/ALPHA_WORKFLOW.md). Rapid Alpha Producer supplies selected ideas, not a wholesale replacement. Default to one playable batch, early integration, one review of the principal risk, one repair packet and one checkpoint gate. Three visual rounds are a ceiling for substantial visual uncertainty, not a quota. Preserve all save/physics/determinism/offline closure requirements.
