...
**September12 Tidefin readiness checkpoint:** retain frozen V3 (`art/source/tidefin-candidate-v3/candidate/tidefin-motion.glb`, SHA256 `5f22dfe31acc9c2b16924d0e662d357c92e17af3518a0c2413ba26440e12eb5f`) for isolated review; it is not registered in Play/Author. Its independent8.0 is an Attack/Hurt pose-frame result, not continuous/native admission. Current shipping Tidefin remains the primitive asset; Mossling's admitted external model is a separate family.

Source review identified native timing work before any Tidefin replacement: generic0.7-scale companion catch-up/recovery speeds4.15/6.2m/s would run this candidate's calibrated2.1m/s Run at about1.98×/2.95×. Its0.75s Attack and0.50s Hurt exceed existing0.65s windup/0.16s hurt states, which can interrupt reviewed recovery. Inspect actual playback and event timing before choosing species-specific calibration/latching; do not change global companion behavior or regenerate the rig to conceal this mismatch.

The isolated viewer is `.dream-loop/tidefin-continuous-v3/viewer.html`: exact-hash GLB,0.7scale, DPR1,1× full clips, calibrated0.63/2.1m/s translation, and full one-shot Attack/Hurt. Actual browser execution passes three Walk/Run cycles, completed one-shots and replay with no local-load errors or external requests. Its captured video is evidence for review, not proof that an agent perceived continuous motion. Independent review of32 sequential paused samples prefers V3 and finds no tearing, but does not claim uninterrupted perception or native-screen readability. Native wild/companion timing remains pending. No new Blender/inference job or paid service was started.
