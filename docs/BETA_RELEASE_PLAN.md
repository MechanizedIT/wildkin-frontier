...
The active release target is the staged [early alpha](EARLY_ALPHA_PLAN.md). The current Lush-grove checkpoint adds59 supported Mossling caches, saved opening/partial rewards and indexed multi-residency to the finite continent/coast foundation. All1,319 tests and package gates pass;44.29MB unpacked/20.57MB ZIP. Grove R3 is7.7/10 HOLD and coast R3 remains6.4/10 HOLD; Sunscar bloom R3 remains a separate8/10 admitted composition. Exact new evidence: `art/reviews/lush-groves/receipt.md`.
