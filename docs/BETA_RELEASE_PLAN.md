...
**Bonding (provisional):** approach eligible wildlife without attacking, begin a brief resonance interaction, match clear timing pulses, then carry the newly bonded Wildkin unsecured. Extraction secures it; death loses pending bonds. Start with one pending slot, expandable through upgrades. Selecting a secured active companion at Camp gives a visible follower, a distinct supported ability and a matching revisit reward. This is not an HP reduction/capture projectile mechanic.
