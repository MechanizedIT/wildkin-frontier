...
Current aggregate: **867 tests**, world/campaign synchronization/readiness and portable build/validation pass; **42.97MB unpacked /20.29MB ZIP**. Current build index SHA256 `b37218b0198b7eb566c030334b16b1e1f6f44a3b84be7b24c5b3aaec436e9d3b`. First-run handoff proof remains historical. New native diagnostics and independent reviews cover the changed phone, observation and harvesting paths; they do not establish complete campaign acceptance or physical-phone performance. See BUILD_LOG for exact evidence boundaries.
