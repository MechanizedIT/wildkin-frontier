...
- PC/web playable first, with landscape mobile viability and a portrait fallback. Bound rendering, streaming, simulation and storage; do not claim physical-phone proof from an emulated viewport.
...
F1, F2A forage, F3 outings/atlas and F2B individual wildlife are complete as foundations. F4 adds a shared subtle body tone; separate eyes failed art admission and remain unexpressed. F5A adds one terrace, safe slope and falling risk; arbitrary climbing/swimming and richer landforms remain unfinished. Current scope is F6A physical nursery and feeding, before a garden and breeding. Small complete integrations take priority over stockpiling disconnected modules. Reorder adjacent slices when dependencies or player feedback justify it; record the reason in CURRENT_SLICE.
