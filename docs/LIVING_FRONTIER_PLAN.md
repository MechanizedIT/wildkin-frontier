...
- Latest September12 steering after waking: mobile/casual first, portrait as primary layout, with landscape/desktop support. See MOBILE_IDENTITY.md for Honeycomb research and the completed M1 portrait controls decision. F7B earned research and optional body-tone guidance are now functional beside F2D selected scenery. F1B rolling terrain and F4B clearer body tones are now selected. Next: shipped wildlife variety and cheaper, fuller ground cover in separate lanes. Bound rendering, streaming, simulation and storage; do not claim physical-phone proof from an emulated viewport.
