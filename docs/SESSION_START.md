...
Plan one concrete procedural-world utility for an existing Wildkin using the current region, ability, interaction, resource and persistence owners. Choose the complete player outcome before production; do not expand the roster or add a general quest framework merely to describe it.
