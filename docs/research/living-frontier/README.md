...
**Newest:** [Early-alpha illustrated progress](Early-Alpha-Progress.md) now shows Mossling opening seeded Lush grove caches and the finite continent/coast with surface swimming, alongside useful companion outings, Camp construction and breeding, crystal blooms, province terrain and timing charts. The [early-alpha plan](../../EARLY_ALPHA_PLAN.md) consolidates the one-continent, habitat/species and useful-companion priorities. These local supplements are newer than the dated PDFs below.
