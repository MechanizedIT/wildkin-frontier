...
> **Active September 25 direction:** Wildkin Frontier is now a **PC-first native game target**. The destructible-world vision remains: a large procedural alien frontier with permanent matter edits, material-specific harvesting, structural support/collapse, destructible rocks/terrain/large flora, and persistent dynamic remnants. The completed browser voxel lab is reference evidence, not the shipping stack. Begin engine qualification with **Unity 6.3 LTS + HDRP**; Unreal 5.8 is deferred unless Unity exposes a meaningful blocker. See [Unity-first transition plan](UNITY_FIRST_TRANSITION_PLAN.md), [native destruction representation strategy](NATIVE_DESTRUCTION_REPRESENTATION.md), and [PC engine/matter criteria](PC_ENGINE_BAKEOFF_PLAN.md).
...
The approved destination is an offline single-player exploration and creature-life game on a large procedural alien matter world. Exploration leads; collecting distinct individual Wildkin is second; building, crafting, care, and breeding are third. A habitat is a coherent generated system of terrain, strata, ecology, resources, traversal, landmarks, atmosphere, and Wildkin niches—not a palette swap. The player can permanently alter environmental matter, harvest multiple products from readable materials/parts, and trigger bounded physical collapse when structures lose support. Desktop keyboard/mouse and controller are primary. Native PC visual quality, simulation fidelity, and agent-driven development now take precedence over the former mobile/browser budget.
...
Emberhorn now has a repeated mineral-gathering role: Cragbreaker cracks up to three nearby stone, iron or crystal outcrops with four ordinary hits each, alongside its existing combat and seal behavior. Tough iron can retain a piece for the field tool. Existing finite deposits remain depleted, renewable rocks retain regrowth, and the player still collects physical drops. The actual two-crystal pocket and partial-iron outing are recorded in `art/reviews/cragbreaker-mining/receipt.md`; this is a small useful species role, not a claim that the full roster has distinct mature jobs.

A bounded natural climb and fall-risk foundation, generated terrain/scenery, existing encounters, portrait controls, and the five-slot hotbar are in the build. Skybreak R3 remains selected usable terrain groundwork at4.9/10 HOLD, with lower berry/fiber pockets, an east-cap crystal and a crown Mossling home. The province slice reuses admitted flora, resources and Wildkin in regional recipes while preserving all existing resident/count bounds; each live wildlife set admits at most one additional high-draw regional signature. This is an active local foundation, not a finished regional ecosystem. Selected R3 remains5.5/10 HOLD; exact native and validation evidence is in `art/reviews/regional-provinces/receipt.md`.

September13 discovery checkpoint: one Sunscar Signal Cache east of Camp reuses the admitted receiver and chest. It offers a physical approach/Open action and one-time two-iron/eight-XP reward, with full-pack remainder, failed-save retry, unload and reload ownership under the existing inventory/save path. Its location is authored on validated seeded ground; it is not yet a distributed secret generator. R2 selected7/10 HOLD. Later bounded terrain preparation and scenery recipe/point reuse reduce walking pauses without changing geography or gameplay. Hitches remain; this does not establish phone performance. Evidence: `art/reviews/frontier-discoveries/receipt.md` and `art/reviews/streaming-preparation/receipt.md`.

September13 regional-place checkpoint: rare Sunscar crystal blooms reuse the existing harvestable crystal, cloudflowers, Fen stones and trail stones as a compact natural pocket with an open approach. The crystal is a real finite persistent source, not decoration; fan and cleft layouts preserve stable seeded identity while reserving ordinary forage, scenery, grass and complete wildlife homes. Sites require strong Sunscar purity, full terrain support and wide separation from Camp, the starter route and Signal Cache. Local thinning keeps at most one complete bloom in any3×3 chunk window. These two compositions are early controlled variety rather than endlessly unique landmarks. Selected R3 is8/10 PASS;1,233tests and verify/ZIP pass. Native partial/full harvesting and literal developer/portable reload evidence is retained at `art/reviews/regional-blooms/receipt.md`.

The current early-alpha world is one finite seeded continent centered at(-700,-900). Its irregular coast uses sea level-2, a90m dry transition,12m shallow water and a32m walkable shelf before terrain ends. The ocean presentation borrows the existing streamed residency and stays within three draws. Surface swimming is provisional: WADE keeps ordinary actions, while SWIM blocks the Field Tool, combat, jump, dodge, taming and companion abilities; followers wait at the last dry point. The inward current is visible and joins desired swim velocity before acceleration. Supported last-dry feet remain the resume owner. There are no boats, diving, aquatic species or drowning mechanics. Independent behavior review and all1,300 tests/package gates pass; selected R3 visuals remain6.4/10 HOLD. This is not a public release or physical-phone admission. Evidence: `art/reviews/frontier-coast/receipt.md`.
...
The intended frontier grows through large seeded regions with distinct landform, traversal, life, resources, and discovery grammar. The plan rejects predictable global path grids and palette-only biome swaps. Surface swimming now exists only as the bounded foundation above. Separate overhang meshes/cave instances, broad climbing, weather/day-night, modular compatible Wildkin parts, additional reproduction modes, habitat/food/camp construction, DNA archives/cloning, community discoveries, trusted online trade and any deeper ocean play remain proposed work rather than current gameplay promises.

The [Living Frontier visual fieldbook](research/living-frontier/Living-Frontier-Visual-Fieldbook.pdf) pairs actual screenshots with explicitly labeled concept art. The [research appendix](research/living-frontier/Living-Frontier-Research-Appendix.pdf) and its [editable Markdown](research/living-frontier/Living-Frontier-Research-Appendix.md) record evidence, technical constraints, sources, and the idea ledger. The [image manifest](research/living-frontier/image-manifest.md) identifies actual and proposed images.

## Historical design record

The sections below preserve the finite-campaign design and reusable engineering rationale that preceded the Living Frontier pivot. They are source/history, not the active product promise. Where a retained section conflicts with the current overview or [Current slice](CURRENT_SLICE.md), current scope prevails.

## Historical working concept
