...
1. Read `docs/CURRENT_SLICE.md` first. It is the only authoritative implementation scope for this session.
   During the September 11 overnight goal, also read `docs/OVERNIGHT_MANDATE.md` on resumption and at every batch review. Continue review-driven end-to-end development until Chris says stop; a completed batch is not permission to end the goal.
